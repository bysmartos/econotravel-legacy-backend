      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            if (!(!email || !password || !name_1 || !last_name || !role))
              return [3 /*break*/, 1];
            res
              .status(400)
              .json({
                message: "email, password, name, last name or role missing",
              });
            return [3 /*break*/, 3];
          case 1:
            return [
              4 /*yield*/,
              userModel_1["default"].saveUser(
                __assign(
                  {
                    email: email,
                    password: password,
        ...
        switch (_a.label) {
          ...
          case 1:
            ...
            allUsers
              ...
              : res
                  .status(500)
                  .send("No se pudo visualizar la lista de usuarios");
            return [3 /*break*/, 3];
          case 2:
            error_2 = _a.sent();
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              jwtHandler_1["default"].generateToken(req.body.email),
            ];
          case 1:
            token = _a.sent();
            console.log(token);
        ...
        switch (_b.label) {
          case 0:
            ...
            (_a = req.body),
              ...
              (name_2 = _a.name),
              (last_name = _a.last_name),
              (users = __rest(_a, ["email", "password", "name", "last_name"]));
            if (!(!email || !password || !name_2 || !last_name))
              return [3 /*break*/, 1];
          ...
          case 1:
            return [
              4 /*yield*/,
              userModel_1["default"].updateUser(
                __assign(
                  {
                    email: email,
                    password: password,
