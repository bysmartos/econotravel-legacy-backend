...
var experienciasModel_1 = __importDefault(
  require("../model/experienciasModel")
);
var experienciasController = {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              experienciasModel_1["default"].getExperiencias(),
            ];
          case 1:
            exp = _a.sent();
            res.json(exp);
  ...
  postExperiencia: function (req, res) {
    return __awaiter(void 0, void 0, void 0, function () {
      var _a,
        titulo,
        imagen,
        ...
        switch (_b.label) {
          case 0:
            ...
            (_a = req.body),
              ...
              (precio = _a.precio),
              (duracionhoras = _a.duracionhoras),
              (accesibilidad = _a.accesibilidad),
              (ubicacion = _a.ubicacion),
              (transporte = _a.transporte),
              (duracion = _a.duracion),
              (experiencias = __rest(_a, [
                "titulo",
                "imagen",
                "descripcion",
                "precio",
          ...
          case 1:
            return [
              4 /*yield*/,
              experienciasModel_1["default"].postExperiencia(
                __assign(
                  {
                    titulo: titulo,
                    imagen: imagen,
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              experienciasModel_1["default"].updateExperiencia(
                __assign(
                  {
                    titulo: titulo,
                    imagen: imagen,
  ...
  deleteExperiencia: function (req, res) {
    return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              experienciasModel_1["default"].deleteExperiencia(param),
            ];
          case 1:
            result = _a.sent();
            result
              ? res
                  .status(201)
                  .json({
                    result: "Experiencia deleted with ID: ".concat(param),
                  })
  ...
  getOneExperiencia: function (req, res) {
    return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              experienciasModel_1["default"].getOneExperiencia(param),
            ];
          case 1:
            result = _a.sent();
            result
  ...
  postExperienciaFilter: function (req, res) {
    return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              experienciasModel_1["default"].postExperienciaFilter({
                searcher: searcher,
              }),
            ];
          case 1:
