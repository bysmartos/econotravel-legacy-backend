...
var validateTokenRole = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var token, email, result, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                token = getTokenFrom(req);
                email = tokenVerify(token);
                return [4 /*yield*/, userModel_1["default"].getRole({ email: email })];
            case 1:
                result = _a.sent();
